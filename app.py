...
def hybrid_search(
    ...
    all_bm25_scores = bm25.get_scores(
        tokenized_query
    )
...
def recommend_movies(
    ...
    matched_title = find_best_title_match(
        movie_title,
        movie_titles
    )
...
if search_mode == "Semantic Search":
    ...
    recommendation_input_mode = st.radio(
        "Recommendation Input Method",
        [
            "Dropdown Selection",
            "Type Movie Name"
        ]
